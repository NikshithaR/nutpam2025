export const en = {
  ...
  timeline: {
    ...
    events: [
      ...
      {
        time: "11:00",
        title: "Problem Statements Disclosure",
        description: "Discover the challenges you'll be solving",
      },
      {
        time: "12:00",
      ...
      },
      {
        ...
        description: "Present your progress to mentors",
      },
      {
        time: "16:00",
        title: "Final Review",
        description: "Showcase your completed solutions",
      },
      {
        time: "17:30",
        title: "Winners Announcement",
        description: "Celebrate the most innovative solutions",
      },
    ],
  },
  registration: {
